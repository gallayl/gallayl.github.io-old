  ...
  public Get(): Hobby[] {
    return [
      ...
      },
      {
        ...
        Tags: [
          {
            Name: "BLM utils for EF6",
            Url: "https://github.com/gallayl/FuryTech.BLM",
          },
          {
            Name: "OData to TypeScript tools",
            Url:
              "https://github.com/gallayl/FuryTech.OdataTypescriptServiceGenerator",
          },
          {
            Name: "Aurelia CV Template",
            Url: "https://github.com/gallayl/aurelia-cv-template",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        Tags: [
          ...
          { Name: "Real time strategy", Url: "http://epicport.com/en/dune2" },
          {
            ...
            Url: "http://thewitcher.com/en/witcher3",
          },
