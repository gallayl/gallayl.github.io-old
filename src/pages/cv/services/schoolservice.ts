    ...
    return [
      ...
      },
      {
        ...
        Tags: [
          {
            Name: "Borland C",
            Url: "https://en.wikipedia.org/wiki/Borland_Turbo_C",
          },
          {
            Name: "Turbo Pascal",
          ...
          {
            Name: "Delphi",
            Url: "https://en.wikipedia.org/wiki/Delphi_(programming_language)",
          },
          { Name: "PHP", Url: "https://secure.php.net/" },
          { Name: "MySQL", Url: "https://www.mysql.com/" },
          {
            Name: "Photoshop",
            Url: "http://www.adobe.com/products/photoshopfamily.html",
          },
        ],
        LocationQuery:
